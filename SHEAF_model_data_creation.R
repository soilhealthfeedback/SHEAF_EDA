...
wheat_damage <- subset(damage, Commodity == "WHEAT")
...
library(tidyverse)
merge1 <- merge(wheat_damage,agcensus, by = c("State", "County", "Year"))
...
write.csv(merge3, file = "/nfs/soilsesfeedback-data/Model_data/WHEAT_Model_dataset1.csv")

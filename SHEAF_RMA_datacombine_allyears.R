#--SHEAF_RMA_datacombine_allyears.R
...
rma1988 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1988.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1989 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1989.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1990 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1990.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1991 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1991.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1992 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1992.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1993 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1993.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1994 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1994.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1995 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1995.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1996 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1996.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1997 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1997.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1998 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1998.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma1999 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/1999.txt", sep = "|", header = FALSE, strip.white = TRUE)
rma2000 <- read.csv("/nfs/soilsesfeedback-data/data/RMA/RMA_textfiles1988_2000/2000.txt", sep = "|", header = FALSE, strip.white = TRUE)

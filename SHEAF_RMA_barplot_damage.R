...
SHEAF_RMA_barplot_damage <- function(year, crop, state) {
...
return(barplot(damage$Loss, names.arg = damage$Damage, las = 3, main = paste("RMA Damage Causes for ", year, ", ", state, sep="")))
